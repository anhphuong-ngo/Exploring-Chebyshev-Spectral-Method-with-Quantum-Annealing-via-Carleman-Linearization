...
client = Client.from_config(token='DEV-e282828caf48c9291111ef240d23c778cb003c13')
from dwave.system import LeapHybridSampler
# cloud_sampler = LeapHybridSampler(solver={'id' : 'hybrid_binary_quadratic_model_version2'}, token='DEV-e282828caf48c9291111ef240d23c778cb003c13')

from dwave.system.samplers import DWaveSampler
from dwave.system.samplers import DWaveSampler
from dwave.system.composites import EmbeddingComposite
cloud_sampler = EmbeddingComposite(DWaveSampler(token='DEV-e282828caf48c9291111ef240d23c778cb003c13'))
